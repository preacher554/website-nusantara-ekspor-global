...
const i18n = {
  en: {
    ...
    text: {
      ...
      heroTitle: "Premium Indonesian Coconut Products, Natural Spices & Biomass Energy Exporter",
  ...
  id: {
    ...
    text: {
      ...
      heroTitle: "Eksportir Premium Produk Kelapa, Rempah Alami & Energi Biomassa Indonesia",
  ...
  ar: {
    ...
    text: {
      ...
      heroTitle: "مصدر متميز لمنتجات جوز الهند والتوابل الطبيعية وطاقة الكتلة الحيوية من إندونيسيا",
  ...
  zh: {
    ...
    text: {
      ...
      heroTitle: "印尼优质椰子产品、天然香料与生物质能源出口商",
